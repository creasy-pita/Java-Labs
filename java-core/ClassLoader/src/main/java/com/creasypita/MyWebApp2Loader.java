...
/**
 自定义classloader
 */
public class MyWebApp2Loader extends ClassLoader{
    /**
     * lib:表示加载的文件在jar包中
     ...
     */
    public MyWebApp2Loader(String webPath) throws NoSuchMethodException, SecurityException, MalformedURLException{
